...
## load datasets ----
 ...
 if (Figure_4 == T)
 {
 load (file = 'D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/RObj/nem64.Robj')
 load (file = 'D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/RObj/nem64.gastrodermis.RObj')
 load (file = 'D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/RObj/nem64.muscle7.Robj')
 }
 ### Set up the indices 
...
source ('D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/Robj/NC_ColeJahnel_etal_BULKdata.R')
...
### Figure_1 ----
  if (Figure_1)
  {
    ...
    write.csv(source.fig1c,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig1c.csv')
    ...
    write.csv(DEBulk.filtered,"D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/DataS2_BULK.csv")
    ...
    write.csv(all.markers_Tissues,file = "D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/DataS3_Tissues.csv")
    ...
    write.csv(source.fig1d,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig1d.csv')
    ...
    write.csv(source.figS1g,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.figS1g.csv')
    ...
    write.csv(source.figS2b,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.figS2b.csv')
    ...
    write.csv(source.figS2c,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.figS2c.csv')
...
## Figure_2 ----
  if (Figure_2)
  {
    ...
    if (save.files){
    write.csv(all.markers_Muscle,"D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/DataS4_MuscleDEGs.csv")
    }
    data1=Muscle7
    ...
    write.csv(source.figS3e,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.figS3e.csv')
    ...
    write.csv(source.fig2a,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig2a.csv')
    ...
    write.csv(source.fig2c,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig2c.csv')
    ...
    #### Figure 2d ----
    # speed plot:
    speed = read_excel("D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/SupplementaryData2.xlsx")
    ...
    write.csv(source.fig2d,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig2d.csv')
    ...
    write.csv(source.FigS4,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FigS4.csv')
    ...
    write.csv(source.FS5fast,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS5fast.csv')
    ...
    write.csv(source.FS5slow,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS5slow.csv')
    ...
    # write.csv(source.FS5all,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS5all.csv')
    # 
...
## Figure_3 ----
  if (Figure_3)
  {
    ...
    write.csv(source.fig3a,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.fig3a.csv')
    ...
    if (save.files){
    write.csv(all.markers_TF_Muscle,"D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/DataS6_MuscleDETFs.csv")
    }
    ...
    write.csv(source.FS3f,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS3f.csv')
    ...
    write.csv(source.FS8a,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS8a.csv')
    ...
    write.csv(source.FS8C,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS8C.csv')
    
    Muscl.TFoi <- genes[match(list.S8.2C, genes$gene_short_name),]
    
    write.csv(Muscl.TFoi,"D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/DataS7_MuscleAllTF.csv")
    ...
    write.csv(source.FS8D,file='D:/Alison/manuscripts/MusclePaper/NatureCom.2023/accepted/raw.source.data/source.FS8D.csv')
